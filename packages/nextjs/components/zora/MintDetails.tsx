...
export function MintDetails({ collection, hideToggle, initialOpen = false, ...props }: MintDetailsProps) {
      ...
      <Collapsible.Root defaultOpen={hideToggle} onOpenChange={value => setOpened(value)}>
        <Stack className="zord-mint-details" gap="x3">
          ...
          {maxPerWallet < OPEN_EDITION_SIZE && (
            <CollectionDetailsItem className="zord-mint-details__item" name="Max per address">
              <Text variant="paragraph-sm">
                ...
                {allowlistEntry && `Presale: ${allowlistEntry.maxCanMint} / Public sale: `}
                {maxPerWallet}
              </Text>
            </CollectionDetailsItem>
          )}
            ...
            <Collapsible.Content className={collapsibleContent}>
              <Stack gap="x3">
                ...
                <CollectionDetailsItem
                  ...
                  value={startDate.toLocaleString(...(dateOptions as [string, Intl.DateTimeFormatOptions]))}
                />
