...
export function VideoAsset({ className, controls = true, compact, coverImage, src }: VideoAssetProps) {
  ...
  return (
    <Flex className={styles.minH} position="relative" width="100%" height="100%" overflow="hidden">
      {!ready && (
      ...
      <video
        ...
        style={{
          ...
          maxWidth: "100%",
          objectFit: "contain",
          ...(!ready ? { filter: "blur(5px) !important" } : { filter: "blur(0) !important" }),
        }}
