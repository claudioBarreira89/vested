...
export function AudioRenderer({ style, className, coverImageUrl, src, inverted, compact }: AudioRendererProps) {
    ...
    return (
      <Flex align="center" justify="center" h="100%" w="100%">
        <Flex align="center" justify="center" w="100%" h="100%">
          ...
          >
            <Box position="relative" w="100%" h="100%" className={className} style={style}>
              <Flex
                direction="column"
                align="center"
                justify="center"
