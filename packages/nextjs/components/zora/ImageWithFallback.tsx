...
export function ImageWithFallback({ alt, fallbackSrc, height = "100%", objectFit, src, ...props }: Props) {
  ...
  const fallback = useMemo(() => {
    ...
    else if ([MediaType.AUDIO, MediaType.VIDEO, MediaType.HTML, MediaType.TEXT].includes(mediaType))
