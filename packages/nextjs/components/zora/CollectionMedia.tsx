...
import { AssetRenderer, AssetRendererProps } from "./Assets/AssetRenderer";
...
export function CollectionMedia({ collection, metadata, objectFit = "contain", ...props }: CollectionMediaProps) {
