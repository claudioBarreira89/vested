...
const editionMetadataRendererAddresses: AddressMap = {
  ...
  5: ["0x2f5c21ef9ddff9a1fe76a1c55dd5112fcf2efd39", "0x994decc8802b9bc846c03f6a6eaf5f7876e7428f"],
};
const dropMetadataRendererAddresses: AddressMap = {
  ...
  5: ["0x5956fd16c4d8c4b4711f2551971abb7c2f4af677", "0xb2aa32a3231cf47412214b38a000baeebfa66b9b"],
};
...
export const CREATOR_PROXY_ADDRESS = creatorProxyAddresses[Number(process.env.NEXT_PUBLIC_CHAIN_ID) || 1];

export const EDITIONS_METADATA_RENDERER =
  editionMetadataRendererAddresses[Number(process.env.NEXT_PUBLIC_CHAIN_ID) || 1];

export const DROPS_METADATA_RENDERER = dropMetadataRendererAddresses[Number(process.env.NEXT_PUBLIC_CHAIN_ID) || 1];
...
export const NETWORK_NAME = { 1: "", 4: "Rinkeby", 5: "Goerli" }[process.env.NEXT_PUBLIC_CHAIN_ID || 1] || "";
...
export const CREATE_URL =
  process.env.NEXT_PUBLIC_CHAIN_ID === "1" ? "https://create.zora.co" : "https://testnet.create.zora.co";

const OPEN_SEA_URL = "https://testnets.opensea.io/assets/goerli";
const ZORA_MARKET_URL = "https://market.zora.co/collections";
export const MARKET_URL = process.env.NEXT_PUBLIC_CHAIN_ID === "1" ? ZORA_MARKET_URL : OPEN_SEA_URL;
