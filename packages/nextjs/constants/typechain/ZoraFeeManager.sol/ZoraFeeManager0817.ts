...
export interface ZoraFeeManager0817Interface extends utils.Interface {
  functions: {
...
export interface ZoraFeeManager0817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZoraFeeManager0817Interface;
