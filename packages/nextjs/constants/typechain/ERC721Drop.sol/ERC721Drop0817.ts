...
export interface ERC721Drop0817Interface extends utils.Interface {
  functions: {
    ...
    "manageMarketFilterDAOSubscription(bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "manageMarketFilterDAOSubscription",
    values: [boolean]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "zoraFeeForAmount",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "zoraFeeManager",
    values?: undefined
  ): string;
...
export interface ERC721Drop0817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721Drop0817Interface;
