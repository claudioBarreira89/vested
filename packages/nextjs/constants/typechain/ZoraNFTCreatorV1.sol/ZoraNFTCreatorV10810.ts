...
export interface ZoraNFTCreatorV10810Interface extends utils.Interface {
  functions: {
...
export interface ZoraNFTCreatorV10810 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZoraNFTCreatorV10810Interface;
