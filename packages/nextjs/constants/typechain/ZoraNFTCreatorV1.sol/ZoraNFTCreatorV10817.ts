...
export interface ZoraNFTCreatorV10817Interface extends utils.Interface {
  functions: {
...
export interface ZoraNFTCreatorV10817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZoraNFTCreatorV10817Interface;
