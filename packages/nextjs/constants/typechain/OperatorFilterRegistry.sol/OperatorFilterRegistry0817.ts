...
export interface OperatorFilterRegistry0817Interface extends utils.Interface {
  functions: {
...
export interface OperatorFilterRegistry0817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OperatorFilterRegistry0817Interface;
