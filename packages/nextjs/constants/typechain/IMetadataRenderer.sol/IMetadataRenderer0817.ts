...
export interface IMetadataRenderer0817Interface extends utils.Interface {
  functions: {
...
export interface IMetadataRenderer0817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IMetadataRenderer0817Interface;
