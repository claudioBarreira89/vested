...
export interface DropConfigGetter0817Interface extends utils.Interface {
  functions: {
...
export interface DropConfigGetter0817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DropConfigGetter0817Interface;
