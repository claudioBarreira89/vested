...
export interface IERC721Drop0817Interface extends utils.Interface {
  functions: {
...
export interface IERC721Drop0817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC721Drop0817Interface;
