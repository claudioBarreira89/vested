...
export interface OwnedSubscriptionManager0817Interface extends utils.Interface {
  functions: {
...
export interface OwnedSubscriptionManager0817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OwnedSubscriptionManager0817Interface;
