...
export interface IOperatorFilterRegistry0810Interface extends utils.Interface {
  functions: {
...
export interface IOperatorFilterRegistry0810 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOperatorFilterRegistry0810Interface;
