...
export interface IOperatorFilterRegistry0817Interface extends utils.Interface {
  functions: {
...
export interface IOperatorFilterRegistry0817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOperatorFilterRegistry0817Interface;
