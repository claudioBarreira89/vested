...
export interface ERC721DropStorageV10817Interface extends utils.Interface {
  functions: {
...
export interface ERC721DropStorageV10817 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721DropStorageV10817Interface;
